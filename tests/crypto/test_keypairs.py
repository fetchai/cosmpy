...
class KeyPairTests(unittest.TestCase):
    ...
    def test_restore_private_key(self):
        ...
        self.assertEqual(pk.public_key_hex, '0257bee208dc8028d2d043bee07b0281a6f959190ed18a2a9984d66507998d9668')
        self.assertEqual(pk.public_key_bytes, b'\x02W\xbe\xe2\x08\xdc\x80(\xd2\xd0C\xbe\xe0{\x02\x81\xa6\xf9Y\x19\x0e\xd1\x8a*\x99\x84\xd6e\x07\x99\x8d\x96h')
        self.assertEqual(pk.private_key, 'q25lQ+7yLuTFfZrAk+HEv8jGNwU7ENEUrGatzT6QbFM=')
        self.assertEqual(pk.private_key_hex, 'ab6e6543eef22ee4c57d9ac093e1c4bfc8c637053b10d114ac66adcd3e906c53')
    ...
    def test_create_public_key_from_another(self):
        pk1 = PublicKey(b'\x02W\xbe\xe2\x08\xdc\x80(\xd2\xd0C\xbe\xe0{\x02\x81\xa6\xf9Y\x19\x0e\xd1\x8a*\x99\x84\xd6e\x07\x99\x8d\x96h')
        pk2 = PublicKey(pk1)

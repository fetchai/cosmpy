...
from pycosm.protos.tendermint.types import (
...
_DUPLICATEVOTEEVIDENCE = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="tendermint.types.DuplicateVoteEvidence.total_voting_power",
            index=2,
            number=3,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="tendermint.types.DuplicateVoteEvidence.validator_power",
            index=3,
            number=4,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name="timestamp",
            full_name="tendermint.types.DuplicateVoteEvidence.timestamp",
            index=4,
            number=5,
            type=11,
            cpp_type=10,
...
_LIGHTCLIENTATTACKEVIDENCE = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="tendermint.types.LightClientAttackEvidence.byzantine_validators",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="total_voting_power",
            full_name="tendermint.types.LightClientAttackEvidence.total_voting_power",
            index=3,
            number=4,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name="timestamp",
            full_name="tendermint.types.LightClientAttackEvidence.timestamp",
            index=4,
            number=5,
            type=11,
            cpp_type=10,
...
_EVIDENCELIST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="evidence",
            full_name="tendermint.types.EvidenceList.evidence",
            index=0,
            number=1,
            type=11,
            cpp_type=10,

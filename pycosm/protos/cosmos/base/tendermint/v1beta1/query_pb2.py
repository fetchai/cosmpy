...
from protos.tendermint.p2p import types_pb2 as tendermint_dot_p2p_dot_types__pb2
from protos.tendermint.types import block_pb2 as tendermint_dot_types_dot_block__pb2

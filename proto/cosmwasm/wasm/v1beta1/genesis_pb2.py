...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[gogoproto_dot_gogo__pb2.DESCRIPTOR,cosmwasm_dot_wasm_dot_v1beta1_dot_types__pb2.DESCRIPTOR,cosmwasm_dot_wasm_dot_v1beta1_dot_tx__pb2.DESCRIPTOR,])
...
_GENESISSTATE_GENMSGS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='store_code', full_name='cosmwasm.wasm.v1beta1.GenesisState.GenMsgs.store_code', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='instantiate_contract', full_name='cosmwasm.wasm.v1beta1.GenesisState.GenMsgs.instantiate_contract', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='execute_contract', full_name='cosmwasm.wasm.v1beta1.GenesisState.GenMsgs.execute_contract', index=2,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='sum', full_name='cosmwasm.wasm.v1beta1.GenesisState.GenMsgs.sum',
...
_GENESISSTATE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='params', full_name='cosmwasm.wasm.v1beta1.GenesisState.params', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='codes', full_name='cosmwasm.wasm.v1beta1.GenesisState.codes', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='contracts', full_name='cosmwasm.wasm.v1beta1.GenesisState.contracts', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='sequences', full_name='cosmwasm.wasm.v1beta1.GenesisState.sequences', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='gen_msgs', full_name='cosmwasm.wasm.v1beta1.GenesisState.gen_msgs', index=4,
...
_CODE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='code_id', full_name='cosmwasm.wasm.v1beta1.Code.code_id', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='code_info', full_name='cosmwasm.wasm.v1beta1.Code.code_info', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\310\336\037\000', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='code_bytes', full_name='cosmwasm.wasm.v1beta1.Code.code_bytes', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='pinned', full_name='cosmwasm.wasm.v1beta1.Code.pinned', index=3,
...
_CONTRACT = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='contract_address', full_name='cosmwasm.wasm.v1beta1.Contract.contract_address', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='contract_info', full_name='cosmwasm.wasm.v1beta1.Contract.contract_info', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\310\336\037\000', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='contract_state', full_name='cosmwasm.wasm.v1beta1.Contract.contract_state', index=2,
      number=3, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SEQUENCE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='id_key', full_name='cosmwasm.wasm.v1beta1.Sequence.id_key', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='value', full_name='cosmwasm.wasm.v1beta1.Sequence.value', index=1,
...
_GENESISSTATE_GENMSGS.fields_by_name['store_code'].message_type = cosmwasm_dot_wasm_dot_v1beta1_dot_tx__pb2._MSGSTORECODE
_GENESISSTATE_GENMSGS.fields_by_name['instantiate_contract'].message_type = cosmwasm_dot_wasm_dot_v1beta1_dot_tx__pb2._MSGINSTANTIATECONTRACT
_GENESISSTATE_GENMSGS.fields_by_name['execute_contract'].message_type = cosmwasm_dot_wasm_dot_v1beta1_dot_tx__pb2._MSGEXECUTECONTRACT
...
_GENESISSTATE.fields_by_name['params'].message_type = cosmwasm_dot_wasm_dot_v1beta1_dot_types__pb2._PARAMS
...
_CODE.fields_by_name['code_info'].message_type = cosmwasm_dot_wasm_dot_v1beta1_dot_types__pb2._CODEINFO
_CONTRACT.fields_by_name['contract_info'].message_type = cosmwasm_dot_wasm_dot_v1beta1_dot_types__pb2._CONTRACTINFO
_CONTRACT.fields_by_name['contract_state'].message_type = cosmwasm_dot_wasm_dot_v1beta1_dot_types__pb2._MODEL

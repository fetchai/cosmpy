...
class Query(object):
    ...
    def Checksums(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ibc.lightclients.wasm.v1.Query/Checksums',
    ...
    def Code(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ibc.lightclients.wasm.v1.Query/Code',
